...
const HERO_MEMBERS = [
  { id: "diana", label: "嘉然", imageSrc: "/images/group-photo-1.jpg", imagePosition: "16% center", accent: "bg-[#F8B6C8]" },
  { id: "eileen", label: "乃琳", imageSrc: "/images/group-photo-1.jpg", imagePosition: "50% center", accent: "bg-[#B9A7F5]" },
  { id: "bella", label: "贝拉", imageSrc: "/images/group-photo-1.jpg", imagePosition: "84% center", accent: "bg-[#A8D8FF]" },
  { id: "xinyi", label: "心宜", imageSrc: null, imagePosition: "center", accent: "bg-[#9EE3D4]" },
  { id: "sinuo", label: "思诺", imageSrc: null, imagePosition: "center", accent: "bg-[#FFD88B]" },
];
  ...
  return (
    <div className="group relative overflow-hidden rounded-[28px] border border-white/80 bg-white/70 p-2 shadow-[0_12px_24px_rgba(78,63,112,0.08)] transition hover:-translate-y-1 hover:shadow-[0_20px_30px_rgba(78,63,112,0.12)]">
      ...
      <div className="mt-3 flex items-center justify-between px-1">
        <p className="font-bold text-[#282438]">{member.label}</p>
        <span className={`h-2.5 w-2.5 rounded-full ${member.accent}`} />
      </div>
    </div>
  );
}
